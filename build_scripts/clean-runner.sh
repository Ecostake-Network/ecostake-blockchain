...
rm -rf ../venv || true
rm -rf venv || true
rm -rf ecostake_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf ecostake-blockchain-gui/build || true
rm -rf ecostake-blockchain-gui/daemon || true
rm -rf ecostake-blockchain-gui/node_modules || true
rm ecostake-blockchain-gui/temp.json || true
( cd "$PWD/ecostake-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @ecostake-network/notarize-cli || true
