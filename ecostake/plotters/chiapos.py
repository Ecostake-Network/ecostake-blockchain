"""
NOTE: This contains duplicate code from `ecostake.cmds.plots`.
After `ecostake plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Ecostake Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_ecostake(args, root_path):
