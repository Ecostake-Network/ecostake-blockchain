...
import { Flex, Form, InputBase } from '@ecostake/core';
  ...
  return (
    <Flex flexDirection="column" gap={3}>
      ...
      <Typography variant="body1" color="textSecondary">
        Enter your Ecostake pool contract address and NFT Launcher ID to recover the missing ECO from your plot NFT.
      </Typography>
