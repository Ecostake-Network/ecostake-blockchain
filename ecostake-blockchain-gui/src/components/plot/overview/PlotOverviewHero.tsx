...
import { CardHero, Flex, Link } from '@ecostake/core';
import { PlotHero as PlotHeroIcon } from '@ecostake/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Ecostake. '
              }
              <Link
                target="_blank"
                href="https://github.com/Ecostake-Network/ecostake-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
