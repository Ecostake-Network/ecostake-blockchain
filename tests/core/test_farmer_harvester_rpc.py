...
from ecostake.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from ecostake.plotting.manager import PlotManager
from ecostake.protocols import farmer_protocol
from ecostake.rpc.farmer_rpc_api import FarmerRpcApi
from ecostake.rpc.farmer_rpc_client import FarmerRpcClient
from ecostake.rpc.harvester_rpc_api import HarvesterRpcApi
from ecostake.rpc.harvester_rpc_client import HarvesterRpcClient
from ecostake.rpc.rpc_server import start_rpc_server
...
from ecostake.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "eco"), encode_puzzle_hash(new_ph_2, "eco"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "eco"))
            ...
            assert config["farmer"]["eco_target_address"] == encode_puzzle_hash(new_ph, "eco")
            assert config["pool"]["eco_target_address"] == encode_puzzle_hash(new_ph_3, "eco")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "eco")
