...
from ecostake.consensus.cost_calculator import NPCResult, calculate_cost_of_program
...
from ecostake.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from ecostake.util.cached_bls import LOCAL_CACHE
from ecostake.util.clvm import int_from_bytes
from ecostake.util.condition_tools import pkm_pairs
from ecostake.util.errors import Err, ValidationError
from ecostake.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 ECO per block, or about 0.00005 ECOSTAKE for two
        # spends.
