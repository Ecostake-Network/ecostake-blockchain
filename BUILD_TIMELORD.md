...
required to run a [Timelord](https://github.com/Ecostake-Network/ecostake-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Ecostake-Network/ecostake-blockchain/blob/main/install-timelord.sh)
