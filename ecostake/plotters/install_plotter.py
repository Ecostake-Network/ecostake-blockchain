import os
from ecostake.plotters.bladebit import install_bladebit
from ecostake.plotters.madmax import install_madmax
...
def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        ...
        if not os.path.exists(root_path / "madmax-plotter/build/ecostake_plot"):
