...
from ecostake.cmds.init_funcs import ecostake_full_version_str
from ecostake.protocols.protocol_message_types import ProtocolMessageTypes
from ecostake.protocols.protocol_state_machine import message_response_ok
from ecostake.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from ecostake.protocols.shared_protocol import Capability, Handshake
from ecostake.server.outbound_message import Message, NodeType, make_msg
from ecostake.server.rate_limits import RateLimiter
...
from ecostake.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from ecostake.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSEcostakeConnection:
    """
