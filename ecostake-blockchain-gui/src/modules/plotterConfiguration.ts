...
export const defaultPlotter = (): Plotter => {
  return {
    displayName: "Ecostake Proof of Space",
    options: optionsForPlotter(PlotterName.ECOSTAKEPOS),
    defaults: defaultsForPlotter(PlotterName.ECOSTAKEPOS),
...
const initialState: PlotterConfigurationState = {
  availablePlotters: {
    [PlotterName.ECOSTAKEPOS]: defaultPlotter(),
  },
