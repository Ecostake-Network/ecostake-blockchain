...
from ecostake.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "ecostake" in cc_discrepancies:
                    cc_discrepancies["ecostake"] = cc_discrepancies["ecostake"] + diff
                else:
                    cc_discrepancies["ecostake"] = diff
