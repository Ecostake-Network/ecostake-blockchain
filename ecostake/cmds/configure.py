...
from ecostake.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "49444"
            # testnet_introducer = "beta1_introducer.ecostake.online"
            # testnet_dns_introducer = "dns-introducer-testnet7.ecostake.online"
            testnet = "testnet"
            ...
            mainnet_port = "38444"
            # mainnet_introducer = "introducer.ecostake.online"
            # mainnet_dns_introducer = "dns-introducer.ecostake.online"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running ecostake services for changes to take effect")
