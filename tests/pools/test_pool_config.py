...
from ecostake.pools.pool_config import PoolWalletConfig
from ecostake.util.config import load_config, save_config, create_default_ecostake_config
...
def test_pool_config():
    ...
    create_default_ecostake_config(test_root, ["config.yaml"])
