...
from ecostake.consensus.block_rewards import calculate_base_farmer_reward
from ecostake.consensus.coinbase import create_puzzlehash_for_pk
from ecostake.pools.pool_puzzles import SINGLETON_MOD_HASH, create_p2_singleton_puzzle
from ecostake.pools.pool_wallet import PoolWallet
from ecostake.pools.pool_wallet_info import FARMING_TO_POOL, PoolState, PoolWalletInfo, create_pool_state
from ecostake.protocols.protocol_message_types import ProtocolMessageTypes
from ecostake.server.outbound_message import NodeType, make_msg
from ecostake.simulator.simulator_protocol import FarmNewBlockProtocol
...
from ecostake.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from ecostake.util.path import path_from_root
...
from ecostake.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from ecostake.wallet.util.trade_utils import trade_record_to_dict
...
from ecostake.wallet.wallet_info import WalletInfo
from ecostake.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "ecostake_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "ecostake_wallet", "wallet_ui")]
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("eco_target_address")
        pool_target = config["pool"].get("eco_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from ecostake.pools.pool_wallet_info import initial_pool_state_from_dict
