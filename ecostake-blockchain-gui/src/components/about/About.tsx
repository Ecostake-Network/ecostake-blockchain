...
import icon from '../../assets/img/ecostake_circle.svg';
...
const url = 'https://www.ecostake.online';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2022 Ecostake Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Ecostake-Network/ecostake-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
