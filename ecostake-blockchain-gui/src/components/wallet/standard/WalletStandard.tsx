...
import {
  ...
  Fee,
  Form,
  TextField as EcostakeTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
...
import { /* mojo_to_ecostake_string, */ ecostake_to_mojo } from '../../../util/ecostake';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_ecostake_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of ecostake in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Ecostake that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Ecostake that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send ecostake to coloured address. Please enter a ecostake
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'ecostake_addr://') {
    ...
    const feeValue = Number.parseFloat(ecostake_to_mojo(fee));
