...
from ecostake.cmds.configure import configure_cmd
from ecostake.cmds.farm import farm_cmd
from ecostake.cmds.init import init_cmd
from ecostake.cmds.keys import keys_cmd
from ecostake.cmds.netspace import netspace_cmd
from ecostake.cmds.passphrase import passphrase_cmd
from ecostake.cmds.plotnft import plotnft_cmd
from ecostake.cmds.plots import plots_cmd
from ecostake.cmds.plotters import plotters_cmd
from ecostake.cmds.show import show_cmd
from ecostake.cmds.start import start_cmd
from ecostake.cmds.stop import stop_cmd
from ecostake.cmds.wallet import wallet_cmd
from ecostake.util.default_root import DEFAULT_KEYS_ROOT_PATH, DEFAULT_ROOT_PATH
from ecostake.util.keychain import set_keys_root_path, supports_keyring_passphrase
from ecostake.util.ssl_check import check_ssl
...
@click.group(
    help=f"\n  Manage ecostake blockchain infrastructure ({DIST_NAME} {__version__})\n",
    epilog="Try 'ecostake start node', 'ecostake netspace -d 192', or 'ecostake show -s'",
...
def cli(
    ...
    if passphrase_file is not None:
        from ecostake.cmds.passphrase_funcs import cache_passphrase, read_passphrase_from_file
