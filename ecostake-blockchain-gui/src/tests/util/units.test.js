...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of ecostake', () => {
      const result = units.getUnit('ecostake');
    ...
    it('gets unit of ecostake using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of ecostake', () => {
      const result = units.getDisplay('ecostake');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('ecostake', 9);

      const result = units.getUnit('ecostake');

      expect(result).toEqual(9);

      units.setUnit('ecostake', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('ecostake', {
        format: '{amount} TECOSTAKE',
        fractionDigits: 0,
      });
