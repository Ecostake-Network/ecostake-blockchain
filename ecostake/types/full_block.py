...
from ecostake.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from ecostake.types.blockchain_format.vdf import VDFProof
