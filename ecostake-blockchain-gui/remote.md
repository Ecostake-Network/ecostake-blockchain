...
````bash
~/.ecostake/<currentversion>/config/ssl/daemon/private_daemon.crt
~/.ecostake/<currentversion>/config/ssl/daemon/private_daemon.key
````
...
````bash
~/.ecostake/<currentversion>/config/ssl/ui/
~/.ecostake/<currentversion>/config/ssl/ui/
````
