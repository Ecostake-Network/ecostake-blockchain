...
from ecostake.consensus.block_root_validation import validate_block_merkle_roots
from ecostake.full_node.mempool_check_conditions import mempool_check_conditions_dict
...
from ecostake.util.generator_tools import (
    additions_for_npc,
