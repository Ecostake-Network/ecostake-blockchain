...
from ecostake.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "ecostake/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "ecostake/wallet/puzzles/cc.clvm",
        "ecostake/wallet/puzzles/chialisp_deserialisation.clvm",
        "ecostake/wallet/puzzles/rom_bootstrap_generator.clvm",
        "ecostake/wallet/puzzles/generator_for_single_coin.clvm",
        "ecostake/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "ecostake/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "ecostake/wallet/puzzles/lock.inner.puzzle.clvm",
        "ecostake/wallet/puzzles/p2_conditions.clvm",
        "ecostake/wallet/puzzles/p2_delegated_conditions.clvm",
        "ecostake/wallet/puzzles/p2_delegated_puzzle.clvm",
        "ecostake/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "ecostake/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "ecostake/wallet/puzzles/p2_puzzle_hash.clvm",
        "ecostake/wallet/puzzles/rl_aggregation.clvm",
        "ecostake/wallet/puzzles/rl.clvm",
        "ecostake/wallet/puzzles/sha256tree_module.clvm",
        "ecostake/wallet/puzzles/singleton_top_layer.clvm",
        "ecostake/wallet/puzzles/did_innerpuz.clvm",
        "ecostake/wallet/puzzles/decompress_puzzle.clvm",
        "ecostake/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "ecostake/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "ecostake/wallet/puzzles/block_program_zero.clvm",
        "ecostake/wallet/puzzles/test_generator_deserialize.clvm",
        "ecostake/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "ecostake/wallet/puzzles/p2_singleton.clvm",
        "ecostake/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "ecostake/wallet/puzzles/pool_member_innerpuz.clvm",
        "ecostake/wallet/puzzles/singleton_launcher.clvm",
        "ecostake/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["ecostake/wallet/puzzles/create-lock-puzzlehash.clvm", "ecostake/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "ecostake/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to ecostake/wallet/puzzles, but not added to `wallet_program_files`
        """
