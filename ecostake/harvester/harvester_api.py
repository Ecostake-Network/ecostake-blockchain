...
from ecostake.harvester.harvester import Harvester
from ecostake.plotting.util import PlotInfo, parse_plot_info
from ecostake.protocols import harvester_protocol
from ecostake.protocols.farmer_protocol import FarmingInfo
from ecostake.protocols.harvester_protocol import Plot
from ecostake.protocols.protocol_message_types import ProtocolMessageTypes
from ecostake.server.outbound_message import make_msg
...
from ecostake.util.ints import uint8, uint32, uint64
from ecostake.wallet.derive_keys import master_sk_to_local_sk
from ecostake.wallet.derive_chives_keys import master_sk_to_chives_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSEcostakeConnection
    ):
        """
        ...
        for filename_sublist_awaitable in asyncio.as_completed(awaitables):
            ...
            if time_taken > 10:
                self.harvester.log.warning(
                    f"Looking up qualities on {filename} took: {time_taken}. This should be below 10 seconds "
        ...
        self.harvester.log.info(
            ...
            f"Total {self.harvester.plot_manager.plot_count()} plots with staking factor {self.currentDiff}"
        )
