...
from ecostake.consensus.network_type import NetworkType
from ecostake.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from ecostake.farmer.farmer import Farmer
from ecostake.protocols import farmer_protocol, harvester_protocol
from ecostake.protocols.harvester_protocol import PoolDifficulty
...
from ecostake.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSEcostakeConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def new_signage_point(self, new_signage_point: farmer_protocol.NewSignagePoint, peer: ws.WSEcostakeConnection):
        try:
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSEcostakeConnection):
