...
from ecostake.server.start_full_node import SERVICE_NAME
...
from ecostake.consensus.pot_iterations import calculate_iterations_quality
from ecostake.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
