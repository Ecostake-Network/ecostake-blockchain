...
from ecostake.wallet.puzzles.p2_conditions import puzzle_for_conditions
from ecostake.wallet.puzzles import singleton_top_layer
from ecostake.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - ecostake.pools.pool_puzzles.py
    - ecostake.wallet.puzzles.pool_member_innerpuz.clvm
    - ecostake.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
